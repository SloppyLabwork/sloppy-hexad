...
function App() {
  ...
  useEffect(() => {
    ...
    window.SLOPPY_SOCKET.addEventListener('message', updateStateOnMessage)
    return () => {
      window.SLOPPY_SOCKET.removeEventListener('message', updateStateOnMessage)
    }
  })
